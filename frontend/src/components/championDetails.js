        ...
        <div className="container text-center mb-2">
            <div className="row">
                <div className="col-1">
                    ...
                    <img id="championImg" key={"https://ddragon.leagueoflegends.com/cdn/12.19.1/img/champion/" + props.championKey + ".png"} src={"https://ddragon.leagueoflegends.com/cdn/12.19.1/img/champion/" + props.championKey + ".png"} alt={props.championKey} className="championData"/>
